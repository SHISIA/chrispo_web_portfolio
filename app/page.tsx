...
import Shots from './components/MoreShots';
      ...
      {!isPortfolio && (
        <>
          ...
          <div className="hidden sm:flex flex-row space-x-5 py-6 fixed top-0 bg-white z-50 w-full items-center justify-center h-16">
            ...
            <a href='#portfolio' onClick={() => setIsportfolio(!isPortfolio)} className="cursor-pointer hover:bg-slate-900 w-24 hover:text-white text-gray-900 rounded-3xl p-2" >Portfolio</a>
